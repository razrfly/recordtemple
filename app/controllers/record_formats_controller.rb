class RecordFormatsController < ApplicationController
  ...
  def create
    ...
    if @record_format.save
      redirect_to record_formats_path, :notice => "Record format was successfully created."
    else
      render :new
    end
  end
  ...
  def update
    if @record_format.update_attributes(record_format_params)
      redirect_to record_formats_path, :notice => "Record format was successfully updated."
    else
      render :edit
    end
  end
  ...
  def destroy
    ...
    redirect_to record_formats_path, :notice => "Record format was successfully deleted."
  end
